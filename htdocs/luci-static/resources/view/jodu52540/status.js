...
return view.extend({
    ...
    render: function() {
        ...
        <div class="cbi-map" id="cbi-jodu52540">
            ...
            <div class="sa-grid-top">
                <div class="cbi-section-node sa-card">
                    <div class="sa-icon">
                        <img src="/luci-static/resources/view/jodu52540/jio-logo.png" onerror="this.onerror=null; this.src='https://uxwing.com/wp-content/themes/uxwing/download/brands-and-social-media/jio-logo-icon.png';" style="width: 48px; height: 48px; border-radius: 50%; object-fit: contain; filter: drop-shadow(0 4px 6px rgba(0,0,0,0.3));">
                    </div>
        ...
        rebootBtn.addEventListener('click', function() {
            if (confirm('Are you sure you want to reboot the Jio ODU?')) {
                uci.load('jodu52540').then(function() {
                    var ip = uci.get('jodu52540', 'main', 'ip') || '192.168.225.1';
                    ...
                    var cmds = "/usr/libexec/jodu_reboot_52540.sh >/dev/null 2>&1 &";
        ...
        btn.addEventListener('click', function() {
            uci.load('jodu52540').then(function() {
                var ip = uci.get('jodu52540', 'main', 'ip') || '192.168.225.1';
                var arfcn = uci.get('jodu52540', 'main', 'arfcn') || '';
                var pci = uci.get('jodu52540', 'main', 'pci') || '';
                ...
                var executeCmd = function() {
                    ...
                    fs.exec_direct('/usr/libexec/jodu_at_52540.sh', [cmd.toUpperCase()]).then(function(res) {
                ...
                btnSave.onclick = function() {
                    ...
                    var cmds = [
                        'uci set jodu52540.main.ip="' + newIp + '"',
                        'uci set jodu52540.main.arfcn="' + newArfcn + '"',
                        'uci set jodu52540.main.pci="' + newPci + '"',
                        'uci commit jodu52540',
                        '/usr/libexec/jodu_lock_52540.sh "' + newArfcn + '" "' + newPci + '"'
                    ].join('; ');
        ...
        poll.add(function() {
            ...
            return fs.exec_direct('/usr/libexec/odu-data-52540.sh').then(function(res) {
                if (isConfiguring) return; 
